    ...
    <div class="q-mb-md">
        ...
        >
            ...
            <template v-slot:body-cell-transactions="props">
                <q-td :props="props">
                    <q-btn dense flat icon="mdi-eye" color="primary" label="View" @click="openDialog(props.row)" />
                </q-td>
            </template>
        </q-table>

        <!-- Dialog to show transactions -->
...
const columns = [
    ...
    { name: 'options', label: 'Options', field: 'event.options', sortable: false }, // 👈 new
